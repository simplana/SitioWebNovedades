...
import { MapPin, Phone, Mail, Clock, Send, MessageCircle, Facebook, Instagram, CheckCircle, AlertCircle } from 'lucide-react';
              ...
              {submitStatus === 'success' && (
                <div className="flex items-start space-x-3 bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700 mt-0.5">Gracias por contactarnos. Te responderemos pronto.</p>
                  </div>
                </div>
              )}
